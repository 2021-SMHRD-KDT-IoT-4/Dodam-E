                        ...
                        <div>
                              <table border="1">
								...
								<div class="col-12" style="margin: 0 auto;float: none;">
									...
									<a href="LogoutService"><input type="submit" id="btn_logout" value="  로그아웃  " /></a>
									
									<%--
									<a href="LogoutService"><input type="submit" id="btn_logout" value="  로그아웃  " /></a>
									<a href="ChilddeleteService"><input type="submit" id="btn_delete" value="  아이 정보 삭제   " /></a>
									<a href="UserdeleteService"><input type="submit" id="btn_drop" value="  회원 탈퇴   " /></a>
									--%>
								</div>
